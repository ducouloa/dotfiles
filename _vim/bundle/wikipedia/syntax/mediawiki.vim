...
" [AD] ajout color wiki
hi wikiH1 ctermfg=196 cterm=underline,bold
hi wikiH2 ctermfg=160 cterm=underline,bold
hi wikiH3 ctermfg=124 cterm=underline,bold
hi wikiH4 ctermfg=88  cterm=underline,bold
hi wikiH5 ctermfg=52  cterm=underline,bold
hi wikiH6 ctermfg=52  cterm=underline,bold
