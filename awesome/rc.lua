...
-- beautiful.init("/home/aducoulombier/.config/awesome/themes/default/theme.lua")
beautiful.init("/home/aducoulombier/.config/awesome/themes/niceandclean/theme.lua")
...
require('orglendar')
-- require("calendar")
-- cr = require("calendar.lua")
orglendar.files = { "/home/aducoulombier/wres/planning/pro.todo",
                    "/home/aducoulombier/wres/planning/perso.todo" }
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ "Mod1", "Control" }, "k",      awful.tag.viewprev       ),
    awful.key({ "Mod1", "Control" }, "j",      awful.tag.viewnext       ),
    ...
    awful.key({ "Mod1", "Control" }, "l", function () awful.screen.focus(2) end),
    awful.key({ modkey, "Control" }, "k", function () awful.screen.focus_relative(-1) end),
    awful.key({ "Mod1", "Control" }, "h", function () awful.screen.focus(1) end),
    ...
    awful.key({ modkey, "Shift"   }, "Return", function () awful.util.spawn(tuxminal) end),
    awful.key({ }, "#180", function () awful.util.spawn('xombrero') end),
    ...
    awful.key({ }, "Pause", function () awful.util.spawn("slock") end),
    -- Multimedia keys
    awful.key({}, "#148", function () awful.util.spawn("gnome-calculator") end),
    awful.key({}, "#163", function () awful.util.spawn("claws-mail") end),
    awful.key({}, "#179", function () awful.util.spawn("cmux") end),
    awful.key({}, "#152", function () awful.util.spawn("terminology") end),
    ...
    awful.key({ "Shift", }, "#171", function () awful.util.spawn("cmus-remote -k +10") end),
    awful.key({}, "#173", function () awful.util.spawn("cmus-remote -r") end),
    awful.key({ "Shift", }, "#173", function () awful.util.spawn("cmus-remote -k -10") end),
    awful.key({}, "#174", function () awful.util.spawn("cmus-remote -s") end),
